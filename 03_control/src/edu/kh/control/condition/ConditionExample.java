...
public class ConditionExample {
	...
	System.out.println("[if문 얘시 1 종료]");
	...
	// if - else if - else
		...
		// The local variable season may not have been initialized (설정한 변수에 초기화가 이루어지지않음, 변수값이 대입되지 않음)
