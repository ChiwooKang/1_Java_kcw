...
public class ConditionPractice {
	...
	public void practice1() {
		/*
		 * 키보드로 입력받은 정수가 양수이면서 짝수일 때만 "짝수입니다."를 출력하고 짝수가 아니면 "홀수입니다."를 출력하세요. 양수가 아니면
		 * "양수만 입력해주세요"를 출력하세요
		 * 
		 * [실행 화면1] 숫자를 한 개 입력하세요 : 8 짝수입니다.
		 * 
		 * [실행 화면2] 숫자를 한 개 입력하세요 : 17 홀수입니다.
		 * 
		 * [실행 화면3] 숫자를 한 개 입력하세요 : -3 양수만 입력해주세요
		 */
...
99월은 잘못 입력된 달입니다
     */
	    ...
	    switch(month) {
	    case 1 : case 3 : case 5 : case 7 : case  8 : case 10 : case 12 : day = month +  "월은 31일까지 있습니다."; break;
	    case 4 : case 6 : case 9 : case 11 : day = month +  "월은 30일까지 있습니다."; break;
	    case 2 : day = month + "월은 28일까지 있습니다."; break;
	    default : day = month +  "월은 잘못 입력된달입니다.";
...
정상체중 */
	...
	public void practice5() {
		...
		if(attendance <= 14 ) {//출석 횟수 부족  // 20-(20 * 0.3) = 14
