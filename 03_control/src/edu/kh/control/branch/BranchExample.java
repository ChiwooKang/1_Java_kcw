...
public class BranchExample {
	...
	public void ex2() {
		...
		while( true ) { //조건식에 강제로 true 작서 == 무한 반복
	...
	public void ex4() {
		...
		for(int i=1 ; i <= 30 ; i++) {
			...
			if(i % 5 == 0) {
				...
				continue; // 다음 반복으로 이동(증감식 부부으로 이동)
			}
	...
	public void upDownGame() {
		...
		// 0.0 <= x < 1.0              0.0이상 1.0 미만의 난수를 생성(double 형)
