...
public class StudentManagementView {
	...
	public void displayMenu() {
		...
		do {
			...
			System.out.println("2. 학생 전체 정보 조회(인덱스)");
	...
	public void printAll() {
		...
		//서비스 객체 필드에 존재하는 stdArr의 값 (Student[] 참조주소)를 얻어와 대입
		// ==얕은 복사
		...
		for(int i=0 ; i<stdArr.length ; i++) {
			if(stdArr[i] == null) {// Student 책체를 참고하지 않는 인덱스가 있을 경우
				break ; // 반복문 종료
	...
	public void selectName() {
		...
		//Student[] edu.kh.objectarray.model.service.StudentManagementService.selectName(String name)
