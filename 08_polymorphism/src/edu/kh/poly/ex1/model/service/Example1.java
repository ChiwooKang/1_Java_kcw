...
//		System.out.println(c1.toString());
		...
		// 			  부모 타입으로 메서드 호출 - 부모 클래스 매서드 연결
		
		// 동적 바인딩 : 프로그램 실행 중 
		//			  참조하는 객제의 실제 타입의 오버라이딩된 메서드 연결
		...
		public void ex2() {
			...
			arr[1] = new Truck(8, 3, "경유", 5.0); // Trcuk 객체(업캐스팅)
			// Car 참조 변수
...
//  }
			...
			public void ex3() {
				...
				// 부모 참조 변수를 자식 타입으로 바꿔
				// 자식 객체를 온전하게 참조할 수있게 만듦.
				...
				// * 해결 방법 : instanceof 연산자로 다운 캐스팅 할 타입이 맞는지 검사
