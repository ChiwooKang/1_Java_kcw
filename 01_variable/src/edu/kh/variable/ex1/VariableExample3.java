...
//글자 크기 조절 : ctrl + (위쪽 숫재 배열) - or + 
public class VariableExample3 {

	//main method(메인 메서드) : 자바 애플리케이션 반드시 필요한 구문
	public static void main(String[]args) {
		...
		int abcdefg;
		int showMeTheMoney;
		int qwertyuiopasdfghjklzxcvbnm; //길이 제한 x
...
//		char void
		...
		// 4. 특수문자는 '$', '_' 만을 허용한다
		//  -> $는 내부클래스 사용시 자동으로 붙여지는 기호 (직접 사용 X)
