...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		boolean booleanData; // 논리 값(true/false)을 저장할 공간 1byte를 메모리에 할당하고,
		...
		// 10000000000(백억)은 int 표기법이므로 int의 최대크기를 넘어설 수 없다.
		// - > long 자료형의 리터럴 표기법은 정수 뒤에 L 또는 l 작성
		
		fNum = 3.14f;
		// float의 리터럴 표기법은 F 또는 f를 뒤에 추가
		dNum = 1.23;
		// double 리터럴 표기법은 기본 실수 표기법
