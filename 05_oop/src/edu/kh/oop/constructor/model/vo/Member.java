...
public class Member {
	...
	public Member(String memberId, String memberPw, String memberPhone, int memberAge) {
		...
		// 오버로딩(OverLoading, 과적)
		// -> 이름 하나로 여러 기능을 수행 할 수 있게 하는 것
		// == 동일한 메서드(또는 생성자)명으로 여러 매서들 작성하는 것

		// 오버로딩의 조건
		// 1. 매서드(생성자) 이름이 같아야 한다.
		// 2. 매개변수가 타입, 개수, 순서 중하나라도 달라야 한다.
	...
	// ** 오버로딩 주의 사항 **
	// -> 매게변수 자료형의 타입, 개수, 순서 중 하나라도 달라야 한다!
	// --> 매개변수명은 사용자가 보기 편하게 하기 위해 의미를 부여하는 것 뿐
	//		컴퓨터한테는 불필요한 요소라서 오버로딩 검사시 인식도지 않음
