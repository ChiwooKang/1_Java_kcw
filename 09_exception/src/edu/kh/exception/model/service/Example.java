...
public class Example {
	...
	public void ex3() {
		...
		}catch(InputMismatchException e) { // chatch문 다중 작성 가능!!!
										  // chatch문이 여러 가면 위에서부터 순서대로
										// 발생한 예외를 검사하여
										// 알맞은 매개 변수를 가진 catch에서 처리한다
